...
<?php writeHead(); ?>
    <!-- InstanceBeginEditable name="Title" --><title>Store | Mahayana Living</title><!-- InstanceEndEditable -->
</head>
<body>
...
<div class="sidebar"> 
    ...
    <div class="section">
        <h3>Our Store</h3>
        <p>We offer a small selection of organic plants, preplanted planters, and some fairy gardens to bring an element of fantasy to your world. If you have any special requests for an item you don't see here or would like for us to carry, please email us at <a href="mailto:mahayanagardens@zendeavors.net">mahayanagardens@zendeavors.net</a> and we will do our best to accomodate you in a timely manner. Thank you for visiting.</p>
    </div> 
    <hr>
    <div class="section">
        <a href="html/blog.html#PestRepel"><img src="images/marigold.jpg" alt="Marigold flower with butterfly">
        <h3>Pest Repellant Plants</h3></a>
        <p>Did you know that you can use living plants to help repell bugs? Check out our blog piece to learn more!</p>
    </div> 
</div>
...
<div class="store">
    ...
    <div class="storeitem">
        ...
        <div class="storedesc">
            We are still planning our flower baskets, but plan to have straight single color and multicolored flowers, as well as multiple variety baskets available. Please use our <a href="html/contact.html">contact page</a> to inquire about our baskets or to make a special request. 
        </div>
        <div class="totop"><a href="#top">Back to Top</a></div>
    </div>
